...
import { submitTask } from '../../api/submissions';
  ...
  const SubmitTaskModal = ({ task, onClose, onSubmitted }) => {
    ...
    return (
<div className="fixed inset-0 bg-black/65 backdrop-blur-sm flex items-center justify-center z-[200] p-4 sm:p-6"
      onClick={onClose}>
      <div className="bg-bg-card border border-border rounded-xl w-full max-w-[92vw] sm:max-w-lg shadow-[0_32px_80px_rgba(0,0,0,0.6)] animate-modal-in max-h-[90vh] overflow-y-auto"
